...
export default async function Page({
    ...
    return (
        <div className="p-4 max-w-7xl mx-auto">
            <h1 className="text-3xl font-extrabold mb-8">User Profile {userId}</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    <h2 className="text-2xl font-bold mb-4">Posts {"-> : "}{userId}</h2>
                ...
                <div>
                    <h2 className="text-2xl font-bold mb-4">Albums {"-> : "}{userId}</h2>
                    <div className="space-y-4">
